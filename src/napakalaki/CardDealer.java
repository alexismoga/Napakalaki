...
public class CardDealer {
    ...
    private void initMonsterCardDeck(){
        ...
        BadConsequence bad1 = new NumericBadConsequence("Pierdes tu armadura visible y otra oculta", 0, 1, 1);
        Prize prize1 = new Prize(2,1);
        unusedMonsters.add(new Monster("3 Byakhees de bonanza", 8, bad1, prize1));
        
        //Tenochtilan
        BadConsequence bad2 = new SpecificBadConsequence("Embobados con el lindo primigenio te descartas de tu casco visible", 0, 
        ...
        //El sopor de Dunwich
        BadConsequence bad3 = new SpecificBadConsequence("El primordial bostezo contagioso. Pierdes el casco visible", 0, 
                new ArrayList(Arrays.asList(TreasureKind.HELMET)), new ArrayList(Arrays.asList()));
        Prize prize3 = new Prize(1,1);
        unusedMonsters.add(new Monster("El sopor de Dunwich", 2, bad3, prize3));
        
        //Demonios de Magaluf
        BadConsequence bad4 = new SpecificBadConsequence("Te atrapan para llevarte de fiesta y te dejan caer en mitad del vuelo. Descarta 1 mano visible y 1 mano oculta", 0,
        ...
        BadConsequence bad5 = new SpecificBadConsequence("Pierdes todos tus tesoros visibles", 0, 
        ...
        //H.P Munchraft
        BadConsequence bad6 = new SpecificBadConsequence("Pierdes la armadura visible", 0, 
                new ArrayList(Arrays.asList(TreasureKind.ARMOR)), 
                new ArrayList(Arrays.asList()));
        ...
        //Necrófago
        BadConsequence bad7 = new SpecificBadConsequence("Sientes bichos bajo la ropa. Descarta la armadura visible", 0, 
        ...
        //El rey de rosado
        BadConsequence bad8 = new NumericBadConsequence("Pierders 5 niveles y 3 tesoros visibles", 5,3,0);
        Prize prize8 = new Prize(4,2);
        unusedMonsters.add(new Monster("El rey de rosado", 13 , bad8, prize8));
        
        //Flecher
        BadConsequence bad9 = new NumericBadConsequence("Toses los pulmones y pierdes 2 niveles", 2 , 0 , 0);
        Prize prize9 = new Prize(1,1);
        unusedMonsters.add(new Monster("Flecher", 2, bad9, prize9));
        
        //Los hondos
        BadConsequence bad10 = new DeathBadConsequence("Estos monstruos resultan bastante superficiales y te aburren mortalmente. Estas muerto",0,0,0, true);
        Prize prize10 = new Prize(2,1);
        unusedMonsters.add(new Monster("Los hondos", 8, bad10, prize10));
        
        //Semillas Cthulhu
        BadConsequence bad11 = new NumericBadConsequence("Pierdes dos niveles y 2 tesoros ocultos", 2, 0, 2);
        Prize prize11 = new Prize(2,1);
        unusedMonsters.add(new Monster("Semillas Cthulhu", 4, bad11, prize11));
        
        //Dameargo
        BadConsequence bad12 = new SpecificBadConsequence("Te intentas escaquear. Pierdes una mano visible",
        ...
        //Pollipólipo volante
        BadConsequence bad13 = new NumericBadConsequence("Da mucho asquito. Pierdes 3 niveles", 3, 0, 0);
        Prize prize13 = new Prize(2,1);
        unusedMonsters.add(new Monster("Pollipólipo volante", 3, bad13, prize13));
        
        //Yskhtihyssg-Goth
        BadConsequence bad14 = new DeathBadConsequence("No le hace gracia que pronuncien mal su nombre. Estas muerto",0,0,0, true);
        Prize prize14 = new Prize(3,1);
        unusedMonsters.add(new Monster("Yskhtihyssg-Goth", 14, bad14, prize14));
        
        //Familia feliz
        BadConsequence bad15 = new DeathBadConsequence("La familia te atrapa. Estas muerto",0,0,0, true);
        Prize prize15 = new Prize(3,1);
        unusedMonsters.add(new Monster("Familia feliz", 1, bad15, prize15));
        
        //Roboggoth
        BadConsequence bad16 = new SpecificBadConsequence("La quinta directiva primaria te obliga a perder 2 niveles y un tesoro 2 manos visible", 2, 
        ...
        //El espía sordo
        BadConsequence bad17 = new SpecificBadConsequence("Te asusta en la noche. Pierdes un casco visible", 0, 
                new ArrayList(Arrays.asList(TreasureKind.HELMET)), new ArrayList(Arrays.asList()));
        Prize prize17 = new Prize(1,1);
        unusedMonsters.add(new Monster("El espía sordo", 5, bad17, prize17));
        
        //Tongue
        BadConsequence bad18 = new NumericBadConsequence("Menudo susto te llevas. Pierdes 2 niveles y 5 tesoros visibles", 2, 5, 0);
        Prize prize18 = new Prize(2,1);
        unusedMonsters.add(new Monster("Tongue", 19, bad18, prize18));
        
        //Bicéfalo
        BadConsequence bad19 = new NumericBadConsequence("Te faltan manos para tanta cabeza. Pierdes 3 nivles y tus tesoros visibles de las manos",
                3, 10, 0);
        ...
        BadConsequence bad20 = new SpecificBadConsequence("Pierdes 1 mano visible", 0, new ArrayList(Arrays.asList(TreasureKind.ONEHAND)), 
                 new ArrayList(Arrays.asList()));
        Prize prize20 = new Prize(3,1);
        unusedMonsters.add(new Monster("El mal indecible impronunciable", 10, bad20, prize20, -2));
    
        //Testigos Oculares
        BadConsequence bad21 = new SpecificBadConsequence("Pierdes tus tesoros visibles", 0, new ArrayList(Arrays.asList(TreasureKind.ARMOR, 
        ...
        //El gran cthulhu
        BadConsequence bad22 = new DeathBadConsequence("Hoy no es tu día de suerte. Mueres",0,0,0, true);
        Prize prize22 = new Prize(2,5);
        unusedMonsters.add(new Monster("El gran cthulhu", 20, bad22, prize22, 4));
        
        //Serpiente Político
        BadConsequence bad23 = new NumericBadConsequence("Tu gobierno te recorta 2 niveles", 2, 0, 0);
        Prize prize23 = new Prize(2,1);
        unusedMonsters.add(new Monster("Serpiente Politico", 8, bad23, prize23, -2));
        
        //Felpuggoth
        BadConsequence bad24 = new SpecificBadConsequence("Pierdes tu casco y tu armadura visible. Pierdes tus manos ocultas", 0, 
        ...
        //Shoggoth
        BadConsequence bad25 = new NumericBadConsequence("Pierdes 2 niveles", 2, 0, 0);
        Prize prize25 = new Prize(4,2);
        unusedMonsters.add(new Monster("Shoggoth", 16, bad25, prize25, -4));
        
        //Lolitagooth
        BadConsequence bad26 = new NumericBadConsequence("Pintalabios negro. Pierdes 2 niveles", 2, 0, 0);
